...
<p>
    Определяется при срабатывании события драга. Возращает контекст табов.
</p>
...
<p>
    Определяется при окончании события драга. Возращает контекст табов.
</p>
...
<p>
    Определяется при смене активной вкладки. Возращает контекст табов.
</p>
...
<p>
    Определяется до выполнения скрипта и создания необходимой разметки. Возращает контекст табов.
</p>
...
<p>
    Определяется после выполнения скрипта и создания необходимой разметки. Возращает контекст табов.
</p>
...
<p>
    При работе с событиями, вам доступны следующие методы контекста табов:
</p>

<h5>moveTo(index)</h5>
<dl class="inline-term">
    <dt>(Integer) index</dt>
    <dd>номер вкладки для переключения</dd>
</dl>

<p>
    Метод переключает активную вкладку по указаному номеру. Нумерация начинается с 0.
</p>
